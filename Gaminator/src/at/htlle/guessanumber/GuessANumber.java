...
public class GuessANumber implements Game, Serializable {
	...
	public String start() {
		if (isSerialized == true) {
			System.out.println("You are now playing your previous game");
		}
	...
	public String next(String inp) {
		...
		if (myNumber == guessed) {
			...
			return "Correct ! " + "This quest took you " + this.nGuesses + " guesses.\n" + "You "
					+ (this.nGuesses < avgTries ? "just had luck" : "could have been better.") + ".";
		}
	...
	public String getHelp() {
		return "Welcome to Guess-a-number. \n" + "The rules are simple: You have to guess the\n"
				...
				+ "if the guessed number is higher or lower than the \n" + "entered one. The range is between 0 and "
				+ this.MAX_NUMBER + "\n" + "With a bit of luck you are gonna make it below "
				+ String.format("%.0f", avgTries) + " tries\n" + "Good Luck !\n";
	}
